...
import it.ness.sample.model.BlankDeliveryOperation;
...
@Singleton
public class BlankDeliveryOperationServiceRs extends RsRepositoryServiceV3<BlankDeliveryOperation, String> {

	public BlankDeliveryOperationServiceRs() {
		super(BlankDeliveryOperation.class);
	}
	...
	@Override
	public PanacheQuery<BlankDeliveryOperation> getSearch(String orderBy) throws Exception {
		PanacheQuery<BlankDeliveryOperation> search;
		Sort sort = sort(orderBy);
		if (sort != null) {
			search = BlankDeliveryOperation.find(null, sort);
		} else {
			search = BlankDeliveryOperation.find(null);
		}
		if (nn("obj.site")) {
