...
public class NotNullStringFilterDef extends FilterDefBase<NotNullStringFilterDef> {

    public NotNullStringFilterDef(final Log log) {
        super(log);
    }
    ...
    public void addAnnotationToModelClass(JavaClassSource javaClass, Set<String> oldLogSet, Set<String> newLogSet) {
        ...
        filterAnnotation.setStringValue("condition", String.format("%s IS NOT NULL", name));
    }

    @Override
    public NotNullStringFilterDef parseCodeBuilderFilterDef(FieldSource<JavaClassSource> f) {
        AnnotationSource<JavaClassSource> a = f.getAnnotation("CodeBuilderNotNullStringFilterDef");
        if (null != a) {
            ...
            NotNullStringFilterDef fd = new NotNullStringFilterDef(log);
            fd.prefix = prefix;
            fd.name = name;
            fd.type = type;
